module fsps_dust
    ...
    ! Smoothing Constants
    real(sp), parameter :: AGB_SMOOTH_LAMBDA_MIN = 1.0e4_sp
    real(sp), parameter :: AGB_SMOOTH_LAMBDA_MAX = 3.0e4_sp
    real(sp), parameter :: AGB_SMOOTH_INSTRM_RES = 1.0e8_sp
...
contains
    ...
    subroutine apply_agb_dust_screen(ctx, weight, spectrum, mass_act, log_t, log_l, &
        ...
        call smoothspec(ctx, ctx%state%spec_lambda, spectrum, &
                        AGB_SMOOTH_LAMBDA_MIN, AGB_SMOOTH_LAMBDA_MAX, AGB_SMOOTH_INSTRM_RES)
